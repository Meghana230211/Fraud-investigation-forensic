		...
		<body>
			...
			<section class="banner-area relative" id="home">	
				...
				<?php }
					...
					<a href="home.php">	
				<?php } ?>
				Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="amendedlogs.php"> Amended Log </a></p>
						</div>											
					</div>
				</div>
			</section>
            ...
            <div class="row">
                <table class="table table-hover table-bordered">
					...
					while($logs_r = mysqli_fetch_array($run_logs)) { ?>
						<tr>
							<td style="font-family:verdana; text-align:center"> <?php echo $logs_r['CASE_ID']; ?> </td>
							<td style="font-family:verdana; text-align:center"> <?php echo $logs_r['USER']; ?> </td>
							<td style="font-family:verdana; text-align:center"> <?php echo $logs_r['DATE']; ?> </td>
						</tr>
					<?php } ?>
					</tbody>
				</table>
