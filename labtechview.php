		...
		<body>
            ...
            <div class="row">
                <table class="table table-hover table-bordered">
					...
					<tbody>
					<?php
					while($labtech_r = mysqli_fetch_array($run_labtech)) { ?>
						<tr>
							<th style="font-family:verdana; text-align:center" scope="row"> <?php echo $labtech_r['TECH_ID']; ?> </th>
							<td style="font-family:verdana; text-align:center"> <?php echo $labtech_r['NAME']; ?> </td>
							<td style="font-family:verdana; text-align:center"> <?php echo $labtech_r['DESIGNATION']; ?> </td>
							<td style="font-family:verdana; text-align:center"> <?php echo $labtech_r['DEPARTMENT']; ?> </td>
						</tr>
					<?php } ?>
					</tbody>
				</table>
