		...
		<body>
			...
			<section class="banner-area relative" id="home">	
				...
				<?php }			
					...
					<a href="home.php">	
				<?php } ?>
				Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="admincases.php"> Cases </a></p>
						</div>											
					</div>
				</div>
			</section>
					...
					<div class="row">
						...
						<div class="col-lg-6 single-services">
							<div class="card text-center" style="width: 18rem;">
								<img style="height:225px; width:225px" class="card-img-top mx-auto" src="img/assigncase.jpg" alt="Card image cap">
								<div class="card-body">
									<h5 class="card-title"> Assign Case </h5>
									<p class="card-text"> Assign Case to Officers </p>
									<a href="assigncases.php" class="btn btn-primary"> Go  </a>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-6 single-services">
							<div class="card text-center" style="width: 18rem;">
								<img style="height:225px; width:225px" class="card-img-top mx-auto" src="img/search.jpg" alt="Card image cap">
								<div class="card-body">
									<h5 class="card-title">  Search  </h5>
									<p class="card-text"> Search for Cases </p>
									<a href=""  data-toggle="modal" data-target="#myModal" class="btn btn-primary"> Go  </a>
								</div>
							</div>
						</div>
